...
export default function NavTab({ setOnClick }) {
    return (
        <div className={styles.nav__container}>
            <div className={styles.nav__container__press}>
                <div className={`${styles['nav__press-contents']} ${styles['contents-select']}`} id="all-press-tab" onClick={setOnClick}>
                    전체 언론사
                </div>
                <div className={`${styles['nav__press-contents']} `} id="my-press-tab" onClick={setOnClick}>
                    내가 구독한 언론사
                </div>
            </div>
            <div className={styles.nav__container__view_type}>
                ...
                <div id="grid-tab">
                    <svg width={30} height={30} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            className={styles['grid-option-select']}
